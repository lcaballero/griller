...
func cliParseTplGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "cli/parse.tpl.go", size: 334, mode: os.FileMode(420), modTime: time.Unix(1476755051, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
